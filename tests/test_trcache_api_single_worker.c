...
int main(int argc, char **argv)
{
        ...
        /* register dummy first to avoid symbol id 0 */
        int dummy_id = trcache_register_symbol(g_tc, "dummy");
        (void)dummy_id;
        g_symbol_id = trcache_register_symbol(g_tc, "sym0");
        ...
        double read_tick_time = timespec_to_sec(&read_tick_perf.end) - timespec_to_sec(&read_tick_perf.start);
