...
CFLAGS_RELEASE = -Wall -Wextra -O2 -std=c11 -fPIC -march=native -D_GNU_SOURCE
CFLAGS_DEBUG = -Wall -Wextra -O0 -g -std=c11 -fPIC -DTRCACHE_DEBUG -march=native -D_GNU_SOURCE
